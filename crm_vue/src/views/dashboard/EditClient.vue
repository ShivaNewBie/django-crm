              ...
              <div class="column is-12">
                <form @submit.prevent="submitForm">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="number" class="input" v-model="client.estimated_value">
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        async getClient(){ //we are getting the data from the backend to update it. It is not shown in the frontend.
